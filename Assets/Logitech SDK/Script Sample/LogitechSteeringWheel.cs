...
public class LogitechSteeringWheel : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Debug.Log("SteeringInit:" + LogitechGSDK.LogiSteeringInitialize(false)); //로그 저장때문에 주석처리
    }

    void OnApplicationQuit()
    {
        Debug.Log("SteeringShutdown:" + LogitechGSDK.LogiSteeringShutdown()); // 로그 저장때문에 주석처리
    }
